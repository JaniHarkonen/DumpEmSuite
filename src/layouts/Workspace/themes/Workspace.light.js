...
const TabBarContainer = styled.div`
    ...
    background-color: ${UIstyle.colorScheme.light.background};
...
const WSTab = styled.div`
    ...
    border-left-color: ${UIstyle.majorBorder.light.color};
    ...
    &:hover {
        cursor: pointer;
        background-color: ${UIstyle.colorScheme.light.distinct};
    }
`;
