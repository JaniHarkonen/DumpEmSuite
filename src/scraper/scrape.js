 ...
 */
export default function scrape(fileString, options = null) {
    ...
    const scrape = (fileString, options) => {
        ...
        const useForm = (options?.form != null);        // Whether to use a custom form
        ...
        while( true )
        {
            ...
            let symbol = {
                ...
                // Use a custom form, if it's provided
            if( useForm )
            {
                let formedSymbol = {};
                ...
                {
                    if( symbol.hasOwnProperty(form[key]) )
                    formedSymbol[key] = symbol[form[key]];
                    else
                    formedSymbol[key] = form[key];
                }
